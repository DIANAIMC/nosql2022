...
Alternativamente, si se quisiera cumplir las 3 condiciones en un mismo grades, entonces sería así:


#+begin_src js
db.restaurants.find({"grades":{$elemMatch:{"grade":'A',"score" : 11, "date": ISODate("2014-08-11T00:00:00Z")}}},{"restaurant_i":1,"name":1,"grades":1})
#+end_src
